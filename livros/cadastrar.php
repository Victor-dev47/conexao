...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
       ...
       $extensao = pathinfo($_FILES['imagem']['name'], PATHINFO_EXTENSION);
        ...
        try{
            ...
            echo "<script>alert('Erro ao cadastrar livro: " . $e->getMessage() . "'); window.history.back();</script>";
        }
    }
    ...
    try {
        ...
        echo "<script>alert('Livro cadastrado com sucesso!'); window.location.href = '../painel.php';</script>";
        exit();
    } catch (PDOException $e) {
        echo "<script>alert('Erro ao cadastrar livro: " . $e->getMessage() . "'); window.history.back();</script>";
    }
